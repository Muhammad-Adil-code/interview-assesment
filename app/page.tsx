  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white text-center py-2 text-xs font-medium">
        CELLTOX CLAIMS 40 BILLION OUT FASTER THAN EXPECTED. LOCK IN YOUR ORDER TODAY TO GET 25% OFF + FREE SHIPPING.
      </div>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 flex justify-center">
              <div className="flex items-center gap-2">
                <img src="/images/logo.jpeg" alt="Iverpure Logo" className="h-10 w-10 object-contain" />
                <span className="text-2xl font-bold text-teal-500">iverpure</span>
              </div>
            </div>
            {/* Icons on the right */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <Button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 text-base font-semibold rounded w-full sm:w-auto">
                SHOP NOW →
              </Button>
      ...
      {/* Testimonial and Collapsible Section - Exact Match */}
      <section className="py-8 bg-white">
      ...
      {/* Three-Stage Process - EXACT MATCH WITH ONE IMAGE PER STAGE */}
      <section className="py-16 bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-3 text-lg font-bold uppercase rounded">
              SHOP NOW →
            </Button>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <Button 
            ...
            className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 text-lg font-bold uppercase rounded"
          >
      ...
      <div className="relative bg-gradient-to-r from-green-100 to-green-50 rounded-2xl p-8 lg:p-12 mb-16 overflow-hidden">
        {/* Decorative leaves */}
        <div className="absolute top-6 left-4" style={{ height: '25rem', width: '20rem' }}>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-start">
            <img
              ...
              className="w-[28rem] h-[30rem] object-contain ml-12"
            />
          </div>

          {/* Right side - Content */}
          <div className="text-center lg:text-left">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">QUALITY GUARANTEED</h2>
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <h2 className="text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12">FREQUENTLY ASKED QUESTIONS</h2>
